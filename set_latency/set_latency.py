...
if __name__ == "__main__":
    ...
    tools.create_logger_environment(set_latency_config, args.loglevel, args.loghandler)

    # get custom field
    custom_field = set_latency_config.get('defaults',{}).get('custom_field', 'latency')

    # we need the SOT object to talk to the SOT
    sot = sot.Sot(token=set_latency_config['sot']['token'], url=set_latency_config['sot']['nautobot'])
